        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h4 className="text-xl font-semibold mb-2 text-gray-900">Register Your Institution</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-xl font-semibold mb-2 text-gray-900">Get CertUni Credits</h4>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h4 className="text-xl font-semibold mb-2 text-gray-900">Issue Verified Certificates</h4>
              <p className="text-gray-600">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-xl font-semibold mb-2 text-gray-900">Global Instant Verification</h4>
                <p className="text-gray-600">
            ...
            <div className="flex items-start gap-4">
              <div className="text-3xl">🔐</div>
              <div>
                <h4 className="text-xl font-semibold mb-2 text-gray-900">Cryptographic Security by Design</h4>
                <p className="text-gray-600">
            ...
            <div className="flex items-start gap-4">
              <div className="text-3xl">📱</div>
              <div>
                <h4 className="text-xl font-semibold mb-2 text-gray-900">QR Code Integration</h4>
                <p className="text-gray-600">
            ...
            <div className="flex items-start gap-4">
              <div className="text-3xl">🚫</div>
              <div>
                <h4 className="text-xl font-semibold mb-2 text-gray-900">Prevents Forgery</h4>
                <p className="text-gray-600">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-700 pt-6 text-center">
            <p className="text-gray-400 mb-3">
              💻 Developed by <span className="font-semibold text-white">Alejandro Rodríguez</span>
            </p>
            <div className="flex items-center justify-center gap-6">
              <a
                href="https://www.linkedin.com/in/alejandrorodriguezpena/"
                target="_blank"
              ...
              <a
                href="https://github.com/arodriguezp2003/certunivertity"
                target="_blank"
                rel="noopener noreferrer"
